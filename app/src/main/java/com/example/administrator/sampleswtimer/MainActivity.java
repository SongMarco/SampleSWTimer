package com.example.administrator.sampleswtimer;
...
public class MainActivity extends Activity {
            ...
            case R.id.btnstart:
                ...
                switch(mStatus){
                    ...
                    case IDLE:
                        ...
                        mBtnStart.setText("일시 정지");
                        mBtnStart.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorAccent) );
                        //옆버튼의 Enable을 푼 다음
                    ...
                    case RUNNING:
                        ...
                        mBtnStart.setText("계속");
                        mBtnStart.setTextColor(ContextCompat.getColor(getApplicationContext(), R.color.colorBlack) );
            ...
            case R.id.btnsplit:
                ...
                switch(mStatus){
                    ...
                    case RUNNING:
                        ...
                        //+연산자로 이어붙임
                        if(!beforeRecord.equals("")){
                            sSplit = String.format("%d :: %s\n\n"+beforeRecord, mSplitCount+1, getEllapse());
                        }
                        else{
                            sSplit += String.format("%d :: %s", mSplitCount+1, getEllapse());
                        }
    ...
    String getEllapse(){
        ...
        String sEll = String.format("%02d:%02d:%02d:%02d",ell/1000 /3600 ,ell / 1000 / 60, (ell/1000)%60, (ell %1000)/10);
